...
import { Layout, Card } from '../../components/wod';
...
const Content = () => {
  ...
  return (
	  // TODO: This is useless in the FLOSS version
    <TextWrapper>
      <Text size={fontSize} color="#FFFFFF">
        Welcome to Workshop on Demand . We offer many
      </Text>
      <Text size={fontSize} color="#FFFFFF">
...
const GrommetMascot = ({ setOpen }) => (
  ...
  <StyledStack>
    <Stack anchor="bottom" alignSelf="start">
      <StyledGremlin>
        <Image alt="gremlinInBubble" src="/img/wod/gremlinInBubble.png" />
      </StyledGremlin>
      <StyledBubble>
        <Image alt="quotebubble" src="/img/wod/quotebubble.png" />
      </StyledBubble>
  ...
  return (
    <>
      <CardWrapper gap="large">
        {size === 'small' && (
          <Card
            logo="/img/wod/StickerPage/gremlin.png"
            title="New to Workshop on Demand?"
...
const Home = ({ data }) => {
  ...
  return (
    <GrommetThemeWrapper>
      <Layout background="/img/wod/BackgroundImages/wod-home-background-min.png">
        <SEO title="Workshop on Demand" />
        <Helmet>
          <body margin="0" />
        </Helmet>
